...
class Film_Model {
	...
	public static function LoadVotes($filmid) {
				...
				$err = $Cstar."/10 - $Bstar";
				$err = '<div id="movie-mark"
     class="btn btn-danger">'.$Cstar.'</div>
<label id="movie-rating">Rating ('.$Bstar.')</label>
<input name="rating" movie-id="'.$filmid.'" class="rating"
       value="0" min="0"
       max="5" step="0.5" data-size="sm"        data-symbol="&#xf005;" data-glyphicon="false"
       data-rating-class="rating-fa" data-show-clear="false">
...
<div class="jtip-bottom">
	...
	public static function Fav_Error($filmid,$epid) {
		...
		Mysql::dbinsert('notice',"nt_content,userid,timeupdate","'Bạn đã được thông báo lỗi phim $filmname. Mời bạn kiểm tra lại.','$userid','$timeupdate'");
		return 1;
	}
