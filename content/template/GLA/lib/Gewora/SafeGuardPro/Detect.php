...
class Detect {
    ...
    public function OS()
    {
        ...
        $os_data = array (
            ...
            'Windows 10' => 'windows|Windows NT 10|Windows 10',
    ...
    public function Location()
    {
        ...
        $ip_data = @json_decode($this->curl->get("http://www.geoplugin.net/json.gp?ip=".$ip));
    ...
    public function ISP($ip = null)
    {
        ...
        $query = @unserialize($this->curl->get('http://ip-api.com/php/'.$ip));
