...
if($mode == 'delete' && $Admingroup == '2') {
	...
	if($mode == 'edit') {
		$arr = MySql::dbselect('name,name_seo','country',"id = '$cid'");
		$name = $arr[0][0];
		$name_seo = $arr[0][1];
	}
