...
<div class="bxh-container">
	<div class="bxh-content">
		<ul id="myTab-bxh" class="nav nav-tabs">
			<li class="active"><a href="#" data-tab="#bxh-day">NGÀY</a></li>
			<li><a href="#" data-tab="#bxh-week">TUẦN</a></li>
			<li class="dropdown"><a href="#" data-tab="#bxh-month">THÁNG</a></li>
			<li class="dropdown pull-right top-imdb"><a href="#" data-tab="#bxh-vote">TOP ĐÁNH GIÁ</a></li>
		</ul>
