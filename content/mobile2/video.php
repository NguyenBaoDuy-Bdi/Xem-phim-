...
<div class="watch-title" style="padding: 0 5% 0px 5%;">
	<div class="watch-now" style="position:relative">
        ...
        <!--<br><iframe src="/player.php?link=<php $getlink = GetLink::Mobile($url); echo rawurlencode($getlink); ?>" frameborder="0" width="900" height="500"></iframe>-->
	</div>
	<div id="video-description" class="player-width">
		<div class="video-description">
			<div class="functional-bar beacon">
				...
				<a href="javascript:void(0);" id="binh-luan" class="player_option_button">Bình luận</a>
			</div>
		</div>
	</div>
</div>
