	...
	<div class="p404">
		<div class="wap">
			<div class="content">
				...
				<span class="tit2">Có thể bạn gõ sai đường dẫn hoặc sai từ khóa tìm kiếm. Hãy sử dụng tính năng tìm kiếm trên website để tìm chính xác bộ phim bạn cần tìm. Nếu vẫn xảy ra lỗi. Hãy liên hệ để được hỗ trợ.skype: <font color=red>hayphimtv</font> hoặc <font color=red>hayphimtv@gmail.com</font> . cảm ơn bạn </span>
				<a class="back" href="<?php echo SITE_URL; ?>">Quay lại Trang chủ
			</div>
		</div>
	</div>
</div>
