...
function player($epid,$type='') {
	...
	*/
	...
	if($linkget != ''){
		$mplayer = '<video id="myplayer" class="video-js vjs-default-skin" controls autoplay="autoplay" width="100%" height="250px" poster="http://hayphimhd.com/content/template/images/cover1.jpg" data-setup="">
